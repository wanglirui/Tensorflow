...
def xml_to_csv(path):
    ...
    train_df.to_csv('csv_data/train.csv', index=None)
    eval_df.to_csv('csv_data/eval.csv', index=None)


def main():
    path = 'D:\\TensorFlow-object-detection\\models-master\\data\\annotations'
    xml_to_csv(path)
